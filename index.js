...
const questionFlow = [
  { question: "Город отправителя", type: "text" },
  { question: "Город получателя", type: "text" },
  { question: "ФИО отправителя", type: "text" },
  { question: "ФИО получателя", type: "text" },
  { question: "Телефон получателя", type: "text" },
  { question: "Адрес получателя", type: "text" },
  { question: "Перечень товаров", type: "text" },
  { question: "Количесто мест (коробок, чемоданов)", type: "text" },
  { question: "Вес", type: "text" },
];
